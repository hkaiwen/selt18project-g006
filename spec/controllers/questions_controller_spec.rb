...
describe QuestionsController do
  ...
  describe 'Add new question' do
    before :each do
      ...
      @level = 'easy'
      @question_array = {:question => @question, :answer => @answer, :option2 => @option1, :option3 => @option2, :option4 => @option3, :explanation => @explanation, :level => @level }
    ...
    it 'should get the values from view' do
      expect(Question).to receive(:create_question!).with(@question_array).and_return(@questions)
    ...
    it 'should flash success message if question added to database and redirect to index page' do
      allow(Question).to receive(:create_question!).with(@question_array).and_return(@questions)
      post :create, {:question => {:question => @question, :answer => @answer, :option2 => @option1, :option3 => @option2, :option4 => @option3, :explanation => @explanation, :level => @level}}
