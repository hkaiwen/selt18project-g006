...
questions = [
  {:questions => 'efficacy means:', :answer => 'capacity or power to produce a desired result', :option2 => 'the state
   ...
   efficacy of broccoli as a health benefit.', :level => 'easy'},
  ...
  {:questions => 'transgression means:', :answer => 'violation', :option2 => 'compression', :option3 => 'persuasion',
   ...
   are cheating on a test, or cheating on a spouse, you are committing transgressions that are not easily forgiven.',:level => 'easy'},
  ...
  {:questions => 'latent means:', :answer => 'not presently active', :option2 => 'perfect and complete in every respect',
   ...
   to describe something that is capable of becoming active or at hand, though it is not currently so.',:level => 'easy'},
  ...
  {:questions => 'arduous means:', :answer => 'laborious', :option2 => 'monstrous', :option3 => 'ominous',
   :option4 => 'perilous', :explanation => 'Use the adjective arduous to describe an activity that takes a lot of
    effort. Writing all those college essays and filling out the applications is an arduous process!',:level => 'easy'},
  ...
  of diseases', :option3 => 'completely unordered and unpredictable and confusing', :option4 => 'free from limitation',
   ...
   The four-year-old who wants a unicorn for her birthday isnt being very pragmatic.',:level => 'easy'},
  ...
  {:questions => 'gregarious means:', :answer => 'outgoing', :option2 => 'solemn', :option3 => 'rustic',
   :option4 => 'frequent', :explanation => 'If you know someone whos outgoing, sociable, and fond of the company of
    others, you might want to call her gregarious.',:level => 'easy'},
  ...
  {:questions => 'mitigated means:', :answer => 'made less severe or harsh', :option2 => 'enlarged or increased',
   ...
   your parents anger by telling them you were late to dinner because you were helping your elderly neighbor.',:level => 'easy'},
  ...
  {:questions => 'The opposite of leader is:', :answer => 'follower', :option2 => 'avatar', :option3 => 'mourner',
   :option4 => 'agent', :explanation => 'A leader is the one in the charge, the person who convinces other people to
    follow. A great leader inspires confidence in other people and moves them to action.',:level => 'easy'},
  ...
  that your vote hardly counts in a Presidential election, though your vote for student council treasurer might feel like
   it has a lot more importance.',:level => 'easy'},
  ...
  {:questions => 'zealot means:', :answer => 'fanatic', :option2 => 'pauper', :option3 => 'narrator',
   :option4 => 'traveler', :explanation => 'The hamburger zealot was so fanatical about his burgers that he camped
    ...
    on them, only ketchup.',:level => 'easy'},

  {:questions => 'digression means:', :answer => 'detour', :option2 => 'delight', :option3 => 'debate',
   :option4 => 'demand', :explanation => 'Digression means detour.',:level => 'easy'},
  ...
  {:questions => 'Which of the following would be considered the most anthropoid?', :answer => 'a chimpanzee',
   ...
   anthropoid, or somewhat resembling a human.',:level => 'easy'},
  ...
  movies, or just going to work.',:level => 'easy'},
  ...
  {:questions => 'insipid means:', :answer => 'uninteresting', :option2 => 'scurvy', :option3 => 'glib',
   ...
   the generic poems inside of greeting cards insipid.',:level => 'easy'},
  ...
  interesting. You can also call them chatty or gabby, but either way, theyre loquacious.',:level => 'easy'},
  ...
  adjective precarious when something is unstable, dangerous or difficult and likely to get worse. Are you totally broke
   and the people you owe money to keep calling? Youre in a precarious financial situation!',:level => 'easy'},
  ...
  {:questions => 'dogmatic means:', :answer => 'characterized by assertion of unproved principles',
   ...
   beliefs so don’t even think of trying to change their minds.',:level => 'easy'},
  ...
  first time you pick up a guitar and start learning to play.',:level => 'easy'},
  ...
  goodwill. If your teacher collects homework with a benevolent smile, shes hoping that youve done a good job.',:level => 'easy'},
  ...
  {:questions => 'benignant means:', :answer => 'kindly', :option2 => 'careful', :option3 => 'uncertain',
   ...
   elementary school was probably the most benignant of them all.',:level => 'easy'},
  ...
  institutions are usually tax deductible',:level => 'easy'},
  ...
  your gracious reply to a rude question like, "So, did you ever learn to hit a softball?"',:level => 'easy'},
  ...
  considerate of their feelings.',:level => 'easy'},
  ...
  hates lurid TV shows — ones that are overly sensationalized and meant to shock.',:level => 'easy'},
  ...
  of it. Hilarious and bizarre YouTube videos certainly exist in profusion.',:level => 'easy'},
 ...
 existence or development', :explanation => 'Rage is a really intense anger. Some frustrated drivers let their emotions
  boil over into road rage when another car cuts them off, for example.',:level => 'easy'},
...
impatience or anger', :option3 => 'devoted to a cause or ideal or purpose', :option4 => 'barely credible',
  ...
  {:questions => 'courteous means:', :answer => 'gracious', :option2 => 'secure', :option3 => 'conscientious',
   ...
   others, like your courteous habit of holding the door for people entering a building with you.',:level => 'easy'},
  ...
  have an imperious attitude and boss you around.',:level => 'easy'},
